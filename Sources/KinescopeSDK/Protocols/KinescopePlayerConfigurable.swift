...
public protocol KinescopePlayerConfigurable {
    ...
    /// Set volume of video
    ///
    /// - parameter volume: A value of `0.0` indicates silence;
    /// a value of `1.0` (the default) indicates full audio volume for the player instance.
    func setVolume(_ volume: Float)

    /// Set speed of video
    ///
    /// - parameter speed: A value of `0.0` pauses the video,
    /// while a value of `1.0` plays the current item at its natural rate.
